...
export default function Home() {
  ...
  if (darkMode) {
    toggleIcon = < BsFillMoonStarsFill onClick={() => setDarkMode(!darkMode)} className='cursor-pointer text-2xl text-gray-900 dark:text-white'/>
  } else {
    toggleIcon = < BsFillSunFill onClick={() => setDarkMode(!darkMode)} className='cursor-pointer text-2xl text-gray-900 dark:text-white'/>
  }
    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      <main className="bg-white px-20 dark:bg-black content-center">
        <section className='min-h-screen' id='top'>
          <nav className='p-10 mx-20 mb-12 flex justify-evenly'>
            <a className='text-2xl font-burtons dark:text-white' href='#top'>trivialtryings</a>
            <ul className='flex items-center'>
              <li>
                {toggleIcon}
              </li>
              <li>
                <a className='text-xl font-burtons text-gray-800 dark:text-white px-2 py-2 ml-4' href='#about'>About Me</a>
              </li>
              <li>
                <a className='text-xl font-burtons text-gray-800 dark:text-white px-2 py-2 ml-4' href='#projects'>Projects</a>
              </li>
              <li>
                <a className='text-xl font-burtons text-gray-800 dark:text-white px-2 py-2 ml-4' href='#'>Resume</a>
              </li>
          ...
          <div className='flex justify-center flex-col items-center pt-14'>
            ...
            <Image src={synth} className='relative bottom-96 -mt-16 z-0' width={280} height={250} alt={"vaporwave"} />
          </div>
        </section>

        <section id="about">
          <h1 className='text-center text-4xl text-teal-500 mb-10'>About Me</h1>
            <div className='container mx-auto px-60 dark:text-white'>
              <div className='float-right rounded-full w-60 h-60 relative overflow-hidden md:h-60 md:w-60'>
              ...
              <p className='py-2 leading-8 text-gray-800 dark:text-white'>You might be wondering why the domain is named <span className='italic text-teal-500'>trivialtryings</span>. By definition,</p>
              <blockquote className='indent-10 font-thin italic' cite="https://www.merriam-webster.com/thesaurus/trivial">
                trivial - as in minor or lacking importance.
              </blockquote>
              <blockquote className='indent-10 font-thin italic' cite="https://www.merriam-webster.com/thesaurus/trying">
                trying - as in hard or difficult to endure.
              </blockquote>
              <p className='py-2 leading-8 text-gray-800 dark:text-white'>I believe that trying new things should be trivial, and that trivial matters should not be trying.</p>

            </div>
        </section>

        <section>
          <div className='container mx-auto px-60 text-3xl flex justify-start gap-16 text-gray-900 m-5'>
